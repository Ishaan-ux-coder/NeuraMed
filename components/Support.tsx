              ...
              <div className="p-10 md:p-14 flex flex-col justify-center relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                  >
                    <Button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-full py-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center relative z-10">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-full px-10 py-7 text-lg shadow-xl">
                <Video className="w-5 h-5 mr-2" />
                Start Peer Call Now
              </Button>
            </motion.div>
