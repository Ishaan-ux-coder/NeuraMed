...
const games = [
  {
    ...
    image: "https://images.unsplash.com/photo-1701588362547-001aaf022089?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwdXp6bGUlMjBnYW1lJTIwcmVsYXhpbmd8ZW58MXx8fHwxNzYxODQ5ODMyfDA&ixlib=rb-4.1.0&q=80&w=1080",
    players: "12K",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1687436874174-977fdd9e2cb8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpdGF0aW9uJTIwcGVhY2VmdWwlMjB3ZWxsbmVzc3xlbnwxfHx8fDE3NjE3ODcxMDV8MA&ixlib=rb-4.1.0&q=80&w=1080",
    players: "8K",
  },
  {
...
const moodStats = [
  { emoji: "😊", label: "Happy", count: 12, color: "from-yellow-400 to-orange-400", bgColor: "from-yellow-100 to-orange-100" },
  { emoji: "😌", label: "Calm", count: 18, color: "from-emerald-400 to-teal-400", bgColor: "from-emerald-100 to-teal-100" },
  { emoji: "😔", label: "Sad", count: 5, color: "from-blue-400 to-cyan-400", bgColor: "from-blue-100 to-cyan-100" },
  { emoji: "😰", label: "Anxious", count: 7, color: "from-purple-400 to-pink-400", bgColor: "from-purple-100 to-pink-100" },
];

export function Games() {
  return (
    <section id="games" className="py-32 px-6 bg-gradient-to-b from-teal-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Relax through interactive games and understand your emotions better with mood tracking.
          </p>
        </motion.div>
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all border border-purple-100">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center gap-2 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                    ...
                    <span className="text-xs font-semibold text-slate-700">{game.players} players</span>
                  </div>
                </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {moodStats.map((mood, index) => (
              ...
              >
                <div className={`bg-gradient-to-br ${mood.bgColor} rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all border border-white relative overflow-hidden`}>
                  {/* Animated background */}
                  <motion.div
          ...
          >
            <p className="text-slate-700 text-center">
              <span className="font-semibold">💡 Insight:</span> You're feeling most calm on Tuesday and Wednesday. 
              Try scheduling important tasks during these peak wellness days!
            </p>
          </motion.div>
        </motion.div>
      </div>
